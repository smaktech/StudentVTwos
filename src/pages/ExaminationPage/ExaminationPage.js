...
export default function ExaminationPage() {
  ...
  return (
    <Box sx={{ width: '95%', m: '0 auto' }}>
      ...
      <Box sx={{ display: 'flex' }}>
        <Button sx={{mr:2}} onClick={() => history(-1)} variant='contained'><ArrowBackIcon />Back</Button>
        ...
        <Grid container spacing={1}>
          <Grid item xs={12} md={10}>
            <Grid item xs={12} md={12}>
              <Grid container spacing={0} sx={{ boxShadow: 2, border: '1px solid #c0ae0c', borderRadius: '20px' }}>
                ...
                <RenderExam subTopic={activeSubTopic} examObj={examObj} />
                {/* </Box>  */}
              </Grid>
            </Grid>
          </Grid>
            ...
            {subTopics.map((items, index) => (
              <Grid item xs={12} md={12} lg={12}>
                <Card
                  ...
                  <CardContent sx={{ padding: { xs: '10px', md: '10px' } }}>
