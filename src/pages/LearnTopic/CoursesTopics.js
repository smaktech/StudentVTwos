...
export default function CoursesSubject(props) {
  ...
  return (
    <>
      ...
      <Box sx={{ width: '95%', m: '0 auto' }}>
        <Button variant='contained' onClick={() => history(-1)}><ArrowBackIcon />Back</Button>
        <Box sx={{ mb: 1,mt:2 }}>
                        ...
                        <Grid item xs={6} md={4} lg={4} key={index}>
                          <Card
                            ...
                            onClick={() => {
                              ...
                              history(`/dashboard/courses/subTopics/${items._id}/${courseName}/${qualificationName}/${subjectName}/${boardName}/${items.name}`);
                            }}>
                            <CardContent sx={{ padding: { xs: '10px', md: '22px' } }}>
                              ...
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center',mt:1 }}>
                                <Typography variant='body1' sx={{ fontSize: { xs: '12px', md: '15px' } }}>{items.description ? items.description.substring(0, 150) : null}</Typography>
