...
import { Box, Typography, Grid, Tabs, Tab, Card, CardContent, CardActions, Divider, Button, Checkbox } from '@mui/material';
...
import PieChart from '../examination/PieChart';
import LineChart from '../examination/LineChart';
import SpiderChart from '../examination/SpiderChart';
import MyReview from '../examination/MyReview';
import AllExam from '../examination/AllExams';
    ...
    <>
      <Grid container spacing={0} sx={{ width: { xs: '90%', md: '98%' }, m: { xs: '0 auto', md: '0 auto' }, p: 0 }}>
          ...
          <Box sx={{ width: '100%' }}>
            ...
            {/* <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                        <Tabs value={tabValue} onChange={handleChange}>
                            <Tab label="My Exam" {...a11yProps(0)} />
                            <Tab label="All Exams" {...a11yProps(1)} />
                        </Tabs>
                    </Box> */}
        ...
        <Grid xs={12} md={3} lg={2.5}>
          <Box sx={{ width: '100%', height: '100vh', marginTop: '0px' }}>
