...
import { getAllEvaluation, getAllReview, editEvaluation, deleteCourse, getEvaluationByFilter, getEvaluationById, getAllUserEvaluations} from '../../api/Evaluation/Evaluation';
...
export default function MyExams() {
    ...
    const [studenteval, setStudenteval] = useState([]);
    ...
    useEffect(() => {
        ...
        getAllReview(page, dataLimit).then((res) => {
            ...
            Getallstudentevallist(page, dataLimit).then((res) => {
            ...
            <TableContainer>
                    <Table>
                        ...
                        <TableRow>
                            ...
                            <TableCell><Button onClick={() =>navigate(`/dashboard/review/viewresults/${row._id}`) }>Results</Button></TableCell>
